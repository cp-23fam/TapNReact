            ...
            <div class="container-flex">
                <div class="row row-cols-md-5 row-cols-1">
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card mx-auto" style="width: 18rem; background-color: #E0E0E0 ; margin: 2vh;">
                            <div class="card-body p-0">
                                <h3 class="card-title text-center p-3" style="background-color: #A3C2D0;"><a href="./games/missing-dot.php" style="font-weight: bold; text-decoration: none; color: #333333;">JOUER !</a></h3>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card mx-auto" style="width: 18rem; background-color: #E0E0E0 ; margin: 2vh;">
                            <div class="card-body p-0">
                                <h3 class="card-title text-center p-3" style="background-color: #A3C2D0;"><a href="./games/flash-dot.php" style="font-weight: bold; text-decoration: none; color: #333333;">JOUER !</a></h3>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card mx-auto" style="width: 18rem; background-color: #E0E0E0 ; margin: 2vh;">
                            <div class="card-body p-0">
                                <h3 class="card-title text-center p-3" style="background-color: #A3C2D0;"><a href="./games/missing-color.php" style="font-weight: bold; text-decoration: none; color: #333333;">JOUER !</a></h3>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card mx-auto" style="width: 18rem; background-color: #E0E0E0 ; margin: 2vh;">
                            <div class="card-body p-0">
                                <h3 class="card-title text-center p-3" style="background-color: #A3C2D0;"><a href="./games/reaction.php" style="font-weight: bold; text-decoration: none; color: #333333;">JOUER !</a></h3>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card mx-auto" style="width: 18rem; background-color: #E0E0E0 ; margin: 2vh;">
                            <div class="card-body p-0">
                                <h3 class="card-title text-center p-3" style="background-color: #A3C2D0;"><a href="./games/infinite-number.php" style="font-weight: bold; text-decoration: none; color: #333333;">JOUER !</a></h3>
